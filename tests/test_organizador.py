...
class TestArrumador(BaseTemporaria):
    def test_organiza_por_tipo(self):
        ...
        self.assertTrue((self.base / "Imagens" / "foto.JPG").is_file())
        self.assertTrue((self.base / "Documentos" / "relatorio.pdf").is_file())
        self.assertTrue((self.base / "Planilhas" / "planilha.xlsx").is_file())
        self.assertTrue((self.base / "Outros" / "desconhecido.zzz").is_file())
        self.assertTrue((self.base / "Sem extensao" / "semextensao").is_file())
    ...
    def test_simulacao_nao_move(self):
        ...
        self.assertFalse((self.base / "Imagens").exists())
    ...
    def test_organiza_por_documento(self):
        ...
        self.assertTrue((self.base / "Sin codigo" / "qualquer coisa.txt").is_file())
...
class TestHistoricoEDesfazer(BaseTemporaria):
    ...
    def test_desfaz_organizacao(self):
        ...
        self.assertFalse((self.trabalho / "Imagens").exists())
    ...
    def test_desfazer_em_simulacao_nao_altera(self):
        ...
        self.assertTrue((self.trabalho / "Imagens" / "foto.png").is_file())
